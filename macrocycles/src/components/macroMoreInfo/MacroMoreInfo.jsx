                  ...
                  >
                    {value.map((session, index) => (
                      <Pressable
                        ...
                        onPress={() => {
                          navigate(`/sessions/${session.id}/${microToSession.id}/${key}/${macrocycleSelected.id}/${microToSession.test || 'na'}`)
                        }}
                      >
                        <View style={Style.containerColumn}>
                          <Txt quick orange>{dayToString[new Date(key).getDay()]}</Txt>
                    ...
                    <View style={Style.containerCenter}>
                      <IconButton
                        onPress={() => navigate(`/sessions/na/${microToSession.id}/${key}/${macrocycleSelected.id}/${microToSession.test || 'na'}`)}
